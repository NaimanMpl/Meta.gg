...
public class ArborescencePanel extends JPanel {
    ...
    /**
     * JPanel modifié selon un design prédéfini pour rendre l'interface
     ...
     * - Les fichiers ODT présents dans le dossier "parent" sous forme de
     * CustomFileInFolder
     ...
     * chaque élément est séparé pour un caractère spécial (ici '>') pour mieux illustrer
