...
public enum MetaAttributes {
    ...
    /**
     * Enumeration qui stock les différents tags (du fichier XML) des attributs que l'on souhaite lire.
     * Cette énumération a pour objectif de simplifier la lecture du code et de stocker les différents
     ...
     * @param title Le titre que l'on souhaite attribuer au tag lors de l'affichage des métadonnées.
     */
